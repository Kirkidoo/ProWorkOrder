        ...
        <form onSubmit={(e) => { e.preventDefault(); onSave(formData); }} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="datetime-local" className={inputClasses} value={formData.startTime.slice(0, 16)} onChange={e => setFormData({ ...formData, startTime: new Date(e.target.value).toISOString() })} />
            </div>
          </div>
